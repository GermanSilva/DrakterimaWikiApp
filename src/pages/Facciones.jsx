...
import { isVisible, plainText, isUnread, readStateMap, getViewerId } from '../helpers'
      ...
      {lista.length === 0 ? (
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-3.5">
          {lista.map(f => (
            ...
            >
              <UnreadDot unread={isUnread(f, 'facciones', viewerId, readState)} className="absolute top-2 right-2" />
